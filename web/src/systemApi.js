...
export function createTenant(payload) { return apiJson(`${API_PREFIX}/system/tenants`, payload, 'POST') }

export function fetchPublicWorkspaces() { return apiGet(`${API_PREFIX}/system/public-workspaces`) }
export function fetchWorkspaceApplications() { return apiGet(`${API_PREFIX}/system/workspace-applications`) }
export function applyToWorkspace(tenantID) { return apiJson(`${API_PREFIX}/system/workspace-applications`, { tenant_id: tenantID }, 'POST') }
export function fetchWorkspaceApplicationReviews(tenantID) { return apiGet(`${API_PREFIX}/system/workspace-applications/reviews`, {}, tenantOptions(tenantID)) }
export function reviewWorkspaceApplication(tenantID, applicationID, payload) { return apiJson(`${API_PREFIX}/system/workspace-applications/${applicationID}`, payload, 'PUT', tenantOptions(tenantID)) }
export function fetchTenantSettings(tenantID) { return apiGet(`${API_PREFIX}/system/tenant-settings`, {}, tenantOptions(tenantID)) }
export function updateTenantSettings(tenantID, payload) { return apiJson(`${API_PREFIX}/system/tenant-settings`, payload, 'PUT', tenantOptions(tenantID)) }
