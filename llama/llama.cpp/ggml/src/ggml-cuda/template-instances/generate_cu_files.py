...
SOURCE_FATTN_MMA_CASE_BERT = "DECL_FATTN_MMA_F16_CASE_BERT({head_size_kq}, {head_size_v}, {ncols1}, {ncols2});\n"
    ...
    for ncols2 in [1, 2, 4, 8, 16, 32]:
        ...
        with open(f"fattn-mma-f16-instance-ncols1_{ncols1}-ncols2_{ncols2}.cu", "w") as f:
            ...
            for head_size_kq in HEAD_SIZES_KQ:
                ...
                if head_size_kq == 64 and head_size_v == 64 and ncols1 == 64 and ncols2 == 1:
                    f.write(SOURCE_FATTN_MMA_CASE_BERT.format(ncols1=ncols1, ncols2=ncols2, head_size_kq=head_size_kq, head_size_v=head_size_v))
