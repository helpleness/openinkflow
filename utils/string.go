...
// TruncateRunes trims surrounding whitespace and shortens text by Unicode rune
// count, so Chinese characters and emoji are never split in the middle.
// A non-positive limit keeps the complete trimmed text.
