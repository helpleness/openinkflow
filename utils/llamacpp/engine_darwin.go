...
// 默认假设你把 llama.cpp 用 CMake 构建到 `llama/cmake-build-release`
// 例如：
//   cmake -S llama -B llama/cmake-build-release -DCMAKE_BUILD_TYPE=Release
//   cmake --build llama/cmake-build-release -j
#cgo LDFLAGS: -L${SRCDIR}/../../llama/cmake-build-release/llama.cpp/src -L${SRCDIR}/../../llama/cmake-build-release/llama.cpp/ggml/src -Wl,-rpath,${SRCDIR}/../../llama/cmake-build-release/llama.cpp/src -Wl,-rpath,${SRCDIR}/../../llama/cmake-build-release/llama.cpp/ggml/src -llama -lggml -lggml-base -lggml-cpu -lc++ -lm -pthread -framework Accelerate
...
var backendOnceDarwin sync.Once

func initBackend() {
	backendOnceDarwin.Do(func() {
